    ...
    return (
      <div>
          ...
          >
            <div className="row">
              <div className="col-lg-8">
                <h1>
                  Welcome to <span>Golden Chef</span>
                </h1>
                <h2>Delivering recipes for more than 5 years!</h2>
                <div className="btns">
                  <a
                    href="http://127.0.0.1:5502/assets/recipe-app-master/add-recipe.html#fd7a63a3-82a8-487f-a125-e4b6c4da1931"
              ...
              >
                <a
                  href="https://www.youtube.com/watch?v=BTOI0czm4uU&ab_channel=YourFoodLab"
        ...
        <main id="main">
          ...
          <div class="container" id="app" data-aos="fade-up">
